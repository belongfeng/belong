...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    @Autowired
    private WechatAppletCasusProperties wechatAppletCasusProperties;

    @Override
    public void configure(HttpSecurity http) throws Exception {
        String[] anonUrls = StringUtils.splitByWholeSeparatorPreserveAllTokens(wechatAppletCasusProperties.getAnonUrl(), ",");
